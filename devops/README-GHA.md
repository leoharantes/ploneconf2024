...
6. Name the environment `ploneconf2024-leoharantes.tangrama.com.br` and hit `Configure environment`.
...
|-------------|--------------|-------------|
| DEPLOY_HOST | ploneconf2024-leoharantes.tangrama.com.br | The hostname or IP address of your Docker Swarm manager. |
...
| Name     | Value |
|----------|-------|
| LIVE_ENV | ploneconf2024-leoharantes.tangrama.com.br |
...
1. Navigate to [Manual Deployment of ploneconf2024-leoharantes.tangrama.com.br](https://github.com/collective/ploneconf2024/actions/workflows/manual-deploy.yml).
...
- Initiate a new deployment using the `devops/stacks/ploneconf2024-leoharantes.tangrama.com.br.yml` stack.
